...
public class CellPhoneMethods {
	...
	int getSamsungModelPrice(String selectedSamsungModel) {
	...
	int getAppleModelPrice(String selectedAppleModel) {
	...
	int getPlanPrice(String selectedNetworkPlan) {
		int planCost = 0;
	...
	void calculateFinalMonthlyPayment(String model, String plan, int modelCost, int planCost) {
